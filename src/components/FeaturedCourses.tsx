  ...
  return (
    <div>
      <div className="text-center">
        ...
        <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-500 ">Learn With the Best</p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          {featuredCourses.map((course: Course) => (
            <div key={course.id} className="flex justify-center">
             ...
             >
              <div className=' p-4 sm:p-6 flex flex-col items-center text-center fleex-grow'>
